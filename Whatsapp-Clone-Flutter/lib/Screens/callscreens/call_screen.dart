...
class _CallScreenState extends State<CallScreen> {
  ...
  Future<void> _connectionAddTrack(
    ...
    if (track.kind == 'video') {
      _videoSender = await _rtcPeerConnection!.addTrack(track, stream);
    } else {
      _audioSender = await _rtcPeerConnection!.addTrack(track, stream);
    }
  }
  ...
  Future<void> _setupPeerConnection() async {
    ...
    for(var track in _localStream!.getTracks()) {
      if(track.kind == 'video') {
        _videoSender = await _rtcPeerConnection!.addTrack(track, _localStream!);
      } else {
        _audioSender = await _rtcPeerConnection!.addTrack(track, _localStream!);
      }
    }
    ...
    var transceivers = await _rtcPeerConnection?.getTransceivers();
